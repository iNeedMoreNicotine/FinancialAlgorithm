...
def European_CRR(S0, K, T, r, q, sigma, layers, call_put, print_out = False):
    dt = T/layers
    u = exp(sigma * sqrt(dt))
    d = exp(-sigma * sqrt(dt))
    p = (exp((r-q)*dt) - d)/(u - d)
    ...
    if call_put == "call":
        ...
        if print_out == True:
            print(f"(CRR Binomial Tree) Price of European {call_put} : {round(callPrice[0], 4)}")
        return callPrice[0]
        ...
        if print_out == True:
            print(f"(CRR Binomial Tree) Price of European {call_put} : {round(putPrice[0], 4)}")
        return putPrice[0]

def American_CRR(S0, K, T, r, q, sigma, layers, call_put, print_out = False):
    dt = T/layers
    u = exp(sigma * sqrt(dt))
    d = exp(-sigma * sqrt(dt))
    p = (exp((r-q)*dt) - d)/(u - d)
    ...
    if call_put == "call":
        ...
        if print_out == True:
            print(f"(CRR Binomial Tree) Price of American {call_put} : {round(callPrice[0], 4)}")
        return callPrice[0]
        ...
        if print_out == True:
            print(f"(CRR Binomial Tree) Price of American {call_put} : {round(putPrice[0], 4)}")
        return putPrice[0]

def European_CRR_Combinatorial(S0, K, T, r, q, sigma, layers, call_put, print_out = False):
    dt = T/layers
    u = exp(sigma * sqrt(dt))
    d = exp(-sigma * sqrt(dt))
    p = (exp((r-q)*dt) - d)/(u - d)
    ...
    if call_put == 'call':
        ...
        if print_out == True:
            print(f"(CRR Binomial Tree) Price of European {call_put} : {round(callValue, 4)} (Combinatorial method)")
        return callValue
        ...
        if print_out == True:
            print(f"(CRR Binomial Tree) Price of European {call_put} : {round(putValue, 4)} (Combinatorial method)")
        return putValue
...
# print(f'n = {layers}')
# print("-------------------------CALL-------------------------")
# European_CRR(S0, K, T, r, q, sigma, layers, "call")
# # American Call
# American_CRR(S0, K, T, r, q, sigma, layers, "call")
# print()
# print("-------------------------PUT-------------------------")
# # European Put
# European_CRR(S0, K, T, r, q, sigma, layers, "put")
# # American Put
# American_CRR(S0, K, T, r, q, sigma, layers, "put")
# print('\n')
...
# print(f'n = {layers}')
# print("--------------------CALL--------------------")
# European_CRR_Combinatorial(S0, K, T, r, q, sigma, layers, 'call')
# print()
# print("--------------------PUT--------------------")
# European_CRR_Combinatorial(S0, K, T, r, q, sigma, layers, 'put')
# print('\n')