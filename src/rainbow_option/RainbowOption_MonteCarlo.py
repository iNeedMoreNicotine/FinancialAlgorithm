...
def rainbow_MC(asset_amount, S0_lst, K, T, r, q_lst, sigma_lst, rho_dict, sims, reps, call_put, print_out = False):
    parameters = dict()
    ...
    if print_out == True:
        print(f'(MC) Mean price of Rainbow European {temp_str} with {asset_amount} assets: {round(meanOfRep, 4)}')
