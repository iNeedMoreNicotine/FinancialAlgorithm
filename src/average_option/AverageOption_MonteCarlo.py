...
def average_EuroCall_MC(StAve, St, K, time_elapsed, time_left_to_maturity, r, q, sigma, n_prev, n, sims, rep, print_out = False):
    ...
    if print_out == True:
        print(f'(MC) Mean price of European Average Call : {round(meanOfRep, 4)}')
...
#     time_elapsed = 0
#     p1 = multiprocessing.Process(target = average_EuroCall_MC, args = [StAve, St, K, time_elapsed, time_left_to_maturity, r, q, sigma, n_prev, n, sims, rep])
#     time_elapsed = 0.25
#     p2 = multiprocessing.Process(target = average_EuroCall_MC, args = [StAve, St, K, time_elapsed, time_left_to_maturity, r, q, sigma, n_prev, n, sims, rep])
